...
INSERT INTO room (id, active, floor, number_of_beds, price, room_number, type, hotel_id) VALUES (600, true, 4, 2, 20, 20, 'Regular', 100);
INSERT INTO room (id, active, floor, number_of_beds, price, room_number, type, hotel_id) VALUES (601, true, 4, 2, 20, 20, 'Regular', 100);
INSERT INTO room (id, active, floor, number_of_beds, price, room_number, type, hotel_id) VALUES (602, true, 4, 4, 25, 20, 'Studio', 100);
INSERT INTO room (id, active, floor, number_of_beds, price, room_number, type, hotel_id) VALUES (603, true, 4, 7, 35, 20, 'Apartman', 100);

insert into car (id, active, brand,doors_number,model, price, seats_number, type, year_of_production, rentacar_company_id) values (500, true, 'Fiat', 5, 'Punto 1.2', 20, 5, 'Sedan', 2010, 100);
insert into car (id, active, brand,doors_number,model, price, seats_number, type, year_of_production, rentacar_company_id) values (501, true, 'BMW', 2, 'Z4', 39, 5, 'Convertible', 2017, 100);
insert into car (id, active, brand,doors_number,model, price, seats_number, type, year_of_production, rentacar_company_id) values (502, true, 'Fiat', 7, '500L', 30, 5, 'Sedan', 2016, 100);

INSERT INTO car_reservation (id, active, drop_off_date, pick_up_date, car_id, customer_id, drop_off_branch_office_id,
pick_up_branch_office_id) VALUES (300, true, '2019-02-25', '2019-01-30', 500, 2002, 100, 101);
INSERT INTO car_reservation (id, active, drop_off_date, pick_up_date, car_id, customer_id, drop_off_branch_office_id,
pick_up_branch_office_id) VALUES (301, true, '2019-02-18', '2019-01-30', 501, 2002, 100, 101);
