...
public class AirCompanyControllerTest {
	...
	@Test
	  public void testGetAllCompanies() throws Exception {
	    ...
	    .andExpect(jsonPath("$.[*].location.id").value(hasItem(AirCompanyConstants.AIR_COMPANY_LOCATION_ID.intValue())));
	  }
	...
	@Test
	  public void testGetAllCompaniesPage() throws Exception {
	    ...
	    .andExpect(jsonPath("$.content.[*].location.id").value(hasItem(AirCompanyConstants.AIR_COMPANY_LOCATION_ID.intValue())));
	  }
	...
	//get/{id}
		@Test
		  public void testGetCompany() throws Exception {
		    ...
		    .andExpect(jsonPath("$.name").value(AIR_COMPANY_NAME))
		...
		public void testEditAirCompany() throws Exception {
			...
			company.setLocation(location);
			String json = TestUtil.json(company);
			this.mockMvc.perform(put(URL_PREFIX + "/edit/" + AIR_COMPANY_ID.intValue()).header("Authorization", "Bearer " + accessTokenAirAdmin)
